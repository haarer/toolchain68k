...
![Build Toolchains](https://github.com/haarer/toolchain68k/workflows/Build%20Toolchains/badge.svg)
...
The script builds on GitHub CI on tag pushes for Linux and Windows. It can also be triggered manually via the GitHub Actions web UI (workflow_dispatch). It may work on other platforms but i dont run any tests.
...
Prebuilt toolchain archives are published on the [GitHub Releases page](https://github.com/haarer/toolchain68k/releases). Each release is triggered by pushing a tag and includes builds for Linux and Windows on all three architectures (m68k-elf, avr, arm-none-eabi).
